...
{
	public class BerserkerBludgeon : ModItem
	{
		...
		{
			this.item.damage = 140;           //The damage of your weapon
			...
			this.item.useTime = 22;          //The time span of using the weapon. Remember in terraria, 60 frames is a second.
			this.item.useAnimation = 22;         //The time span of the using animation of the weapon, suggest set it the same as useTime.
		...
		public override void MeleeEffects(Player player, Rectangle hitbox)
		{
			...
			Vector2 vel = new Vector2( 3 * player.direction, 0 );
			const int spread = 75;
