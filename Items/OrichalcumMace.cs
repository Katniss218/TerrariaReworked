...
{
	public class OrichalcumMace : ModItem
	{
		...
		{
			this.item.damage = 51;           //The damage of your weapon
			...
			this.item.useTime = 30;          //The time span of using the weapon. Remember in terraria, 60 frames is a second.
			this.item.useAnimation = 30;         //The time span of the using animation of the weapon, suggest set it the same as useTime.
			...
			this.item.value = 126500;           //The value of the weapon
