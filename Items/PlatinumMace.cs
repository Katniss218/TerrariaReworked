...
{
	public class PlatinumMace : ModItem
	{
		...
		{
			this.item.damage = 16;           //The damage of your weapon
			...
			this.item.useTime = 26;          //The time span of using the weapon. Remember in terraria, 60 frames is a second.
			this.item.useAnimation = 26;         //The time span of the using animation of the weapon, suggest set it the same as useTime.
