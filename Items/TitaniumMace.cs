...
{
	public class TitaniumMace : ModItem
	{
		...
		{
			this.item.damage = 58;           //The damage of your weapon
			...
			this.item.knockBack = 9.5f;         //The force of knockback of the weapon. Maximum is 20
			this.item.value = 161000;           //The value of the weapon
