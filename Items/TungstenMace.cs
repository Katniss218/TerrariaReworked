...
{
	public class TungstenMace : ModItem
	{
		...
		{
			this.item.damage = 14;           //The damage of your weapon
			...
			this.item.useTime = 27;          //The time span of using the weapon. Remember in terraria, 60 frames is a second.
			this.item.useAnimation = 27;         //The time span of the using animation of the weapon, suggest set it the same as useTime.
			...
			this.item.value = 4500;           //The value of the weapon
