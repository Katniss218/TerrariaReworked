...
namespace TerrariaReworked.NPCs
{
	public class OblivionHead2 : ModNPC
	{
		...
		public override void AI()
		{
			...
			int head1 = NPC.FindFirstNPC( ModMain.instance.NPCType( "OblivionHead1" ) );
			if( head1 >= 0 )
			{
				dir = (Main.player[npc.target].position + new Vector2( 0, -150 )) - npc.position;
			}
			else
			{
		...
		public override bool PreNPCLoot()
		{
			...
			if( NPC.CountNPCS( ModMain.instance.NPCType( "OblivionHead1" ) ) == 0 )
			{
