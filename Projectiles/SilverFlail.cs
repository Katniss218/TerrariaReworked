...
{
	public class SilverFlail : ModProjectile
	{
		...
		public override bool PreDraw( SpriteBatch spriteBatch, Color lightColor )
		{
			...
			Texture2D texture = ModContent.GetTexture( "TerrariaReworked/Projectiles/SilverFlail_Chain" );
