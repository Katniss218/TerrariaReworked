...
namespace TerrariaReworked.Projectiles
{
	public class TrueGungnir : ModProjectile
	{
		...
		{
			this.projectile.width = 23;
			this.projectile.height = 23;
		...
		public override void AI()
		{
			...
			if( !spawned )
			{
				...
				Projectile.NewProjectile( center, target, mod.ProjectileType( "TrueGungnir2" ), (int)(this.projectile.damage * 1.25f), 3, this.projectile.owner );
			...
			{
				int num266 = Dust.NewDust( new Vector2( projectile.position.X, projectile.position.Y ), projectile.width, projectile.height, 57, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 200, default( Color ), 1.2f );
			...
			{
				int num267 = Dust.NewDust( new Vector2( projectile.position.X, projectile.position.Y ), projectile.width, projectile.height, 43, 0f, 0f, 254, default( Color ), 0.3f );
